...
/// ```
#[no_mangle]
pub extern "C" fn tony_puti(x: f64) -> () {
    print_flush!("{}", x);
}
...
///
#[no_mangle]
pub extern "C" fn tony_abs(x: f64) -> f64 {
    x.abs()
}
#[no_mangle]
pub extern "C" fn tony_ord(c: char) -> f64 {
    c as u32 as f64
}
#[no_mangle]
pub extern "C" fn tony_chr(i: f64) -> char {
    i as f64 as u8 as char
}
...
#[no_mangle]
pub extern "C" fn tony_strlen(c: *const std::os::raw::c_char) -> f64 {
    (unsafe { libc::strlen(c) }) as f64
}
...
pub extern "C" fn tony_strcmp(
    ...
    (unsafe { libc::strcmp(s1, s2) }) as f64
}
...
//#[no_mangle]
//pub extern "C" fn tony_putchard(x: f64) -> f64 {
//    print_flush!("{}", x as u8 as char);
//    x
//}
//
//#[no_mangle]
//pub extern "C" fn tony_printd(x: f64) -> f64 {
//    println!("{}", x);
//    x
//}
//
